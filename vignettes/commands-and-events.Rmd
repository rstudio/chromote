...
> **Note:** This sequence of commands, with `Page$navigate()` and then `Page$loadEventFired()` will not work 100% of the time.
> See [Loading a Page Reliably](#loading-a-page-reliably) for more information.
...
For more information, see the [Async events](#async-events) section.
