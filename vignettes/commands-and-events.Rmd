...
The Chrome DevTools Protocol has two types of methods: _commands_ and _events_. Methods like `Page$navigate()` and `DOM$querySelector()` are **commands**. That is, they tell the browser to do something; the browser does it, and then sends back some data.
