...
* While chromote now provides features to download and use any version of Chrome, **do not use these on CRAN**.
  For one, downloading Chrome is not a valuable or considerate use of CRAN's resources.
  Furthermore, you gain little from such a test.
